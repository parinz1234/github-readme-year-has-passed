...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	const tpl = `{{.Top}}<svg viewBox="0 0 400 130" width="400" height="130"><rect width="380" height="80" style="stroke: rgb(0, 0, 0); fill: rgb(51, 51, 51); fill-rule: nonzero;" data-bx-origin="-0.038 -0.658333" x="20" y="50"></rect>
